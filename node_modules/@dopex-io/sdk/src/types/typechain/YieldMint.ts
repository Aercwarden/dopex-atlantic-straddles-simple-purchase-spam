...
export interface YieldMintInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "claimAdminRewards",
  ...
  encodeFunctionData(
    functionFragment: "depositPeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "endDeposits",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "endFarming",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "farmingPeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maxLpDeposits",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setMaxLpDeposit",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "startDeposits",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "uniswapV2Router01",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "usersDeposit",
    values: [PromiseOrValue<string>]
  ): string;
...
export type DepositLPEvent = TypedEvent<
  [string, BigNumber],
  DepositLPEventObject
>;

export type DepositLPEventFilter = TypedEventFilter<DepositLPEvent>;
...
export type endDepositPeriodEvent = TypedEvent<
  [BigNumber],
  endDepositPeriodEventObject
>;

export type endDepositPeriodEventFilter =
  TypedEventFilter<endDepositPeriodEvent>;

export interface endFarmingPeriodEventObject {
  blockTimeStamp: BigNumber;
}
export type endFarmingPeriodEvent = TypedEvent<
  [BigNumber],
  endFarmingPeriodEventObject
>;

export type endFarmingPeriodEventFilter =
  TypedEventFilter<endFarmingPeriodEvent>;
...
export interface YieldMint extends BaseContract {
  ...
  functions: {
    ...
    emergencyWithdraw(
      addressArray: PromiseOrValue<string>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "endDepositPeriod(uint256)"(
      blockTimeStamp?: null
    ): endDepositPeriodEventFilter;
    endDepositPeriod(blockTimeStamp?: null): endDepositPeriodEventFilter;

    "endFarmingPeriod(uint256)"(
      blockTimeStamp?: null
    ): endFarmingPeriodEventFilter;
