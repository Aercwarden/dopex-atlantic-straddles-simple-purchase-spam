...
export type VaultCheckpointStructOutput = [BigNumber, BigNumber, BigNumber] & {
...
export interface SsovV3ViewerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTotalEpochOptionsPurchased",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getTotalEpochPremium",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getWritePositionValue",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface SsovV3Viewer extends BaseContract {
  ...
  functions: {
    ...
    getEpochStrikeTokens(
      ...
      ssov: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string[]] & { strikeTokens: string[] }>;

    getTotalEpochOptionsPurchased(
      epoch: PromiseOrValue<BigNumberish>,
      ssov: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { _totalEpochOptionsPurchased: BigNumber[] }>;

    getTotalEpochPremium(
      epoch: PromiseOrValue<BigNumberish>,
      ssov: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { _totalEpochPremium: BigNumber[] }>;

    getTotalEpochStrikeDeposits(
      epoch: PromiseOrValue<BigNumberish>,
      ssov: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { totalEpochStrikeDeposits: BigNumber[] }>;
