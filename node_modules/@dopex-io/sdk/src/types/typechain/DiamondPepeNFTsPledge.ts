...
export interface DiamondPepeNFTsPledgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "isPledgePeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type LogDistributedEvent = TypedEvent<
  [BigNumber, string, BigNumber],
  LogDistributedEventObject
>;

export type LogDistributedEventFilter = TypedEventFilter<LogDistributedEvent>;

export interface LogPledgedEventObject {
  pledgor: string;
  tokenId: BigNumber;
}
export type LogPledgedEvent = TypedEvent<
  [string, BigNumber],
  LogPledgedEventObject
>;

export type LogPledgedEventFilter = TypedEventFilter<LogPledgedEvent>;
...
export interface DiamondPepeNFTsPledge extends BaseContract {
  ...
  filters: {
    ...
    "LogDistributed(uint256,address,uint256)"(
      randomNumber?: null,
      winner?: null,
      tokenId?: null
    ): LogDistributedEventFilter;
    LogDistributed(
      randomNumber?: null,
      winner?: null,
      tokenId?: null
    ...
    "LogPledged(address,uint256)"(
      pledgor?: null,
      tokenId?: null
    ): LogPledgedEventFilter;
