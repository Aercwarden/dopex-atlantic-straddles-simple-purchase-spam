...
export interface DiamondPepeNFTsPledge2Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "percentPrecision",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "pledgeByIndex",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "pledgeIndex",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "targetVote",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "totalPledged",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type LogBurnEvent = TypedEvent<[BigNumber], LogBurnEventObject>;
...
export type LogNewPledgeEvent = TypedEvent<
  [string, BigNumber[], BigNumber],
  LogNewPledgeEventObject
>;

export type LogNewPledgeEventFilter = TypedEventFilter<LogNewPledgeEvent>;
...
export type LogPledgedPepeEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  LogPledgedPepeEventObject
>;

export type LogPledgedPepeEventFilter = TypedEventFilter<LogPledgedPepeEvent>;
...
export interface DiamondPepeNFTsPledge2 extends BaseContract {
  ...
  filters: {
    ...
    "LogNewPledge(address,uint256[],uint256)"(
      pledgor?: null,
      tokenIds?: null,
      index?: null
    ): LogNewPledgeEventFilter;
    LogNewPledge(
      pledgor?: null,
      tokenIds?: null,
      index?: null
    ...
    "LogPledgedPepe(address,uint256,uint256)"(
      pledgor?: null,
      tokenId?: null,
      index?: null
    ): LogPledgedPepeEventFilter;
    LogPledgedPepe(
      pledgor?: null,
      tokenId?: null,
      index?: null
