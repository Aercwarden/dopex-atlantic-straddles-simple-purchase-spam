...
export interface StakingRewardsV3Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "updateBoostedTimePeriod",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "updateRewardDuration",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export type BoostedTimePeriodUpdatedEvent = TypedEvent<
  [BigNumber],
  BoostedTimePeriodUpdatedEventObject
>;

export type BoostedTimePeriodUpdatedEventFilter =
  TypedEventFilter<BoostedTimePeriodUpdatedEvent>;
...
export interface StakingRewardsV3 extends BaseContract {
  ...
  functions: {
    ...
    rewardPerToken(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { perTokenRate: BigNumber }>;
  ...
  filters: {
    ...
    "BoostedTimePeriodUpdated(uint256)"(
      boostedTimePeriod?: null
    ): BoostedTimePeriodUpdatedEventFilter;
    BoostedTimePeriodUpdated(
      boostedTimePeriod?: null
    ): BoostedTimePeriodUpdatedEventFilter;
