...
import type { NativeSSOV, NativeSSOVInterface } from "../NativeSSOV";
...
export class NativeSSOV__factory {
  static readonly abi = _abi;
  static createInterface(): NativeSSOVInterface {
    return new utils.Interface(_abi) as NativeSSOVInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NativeSSOV {
    return new Contract(address, _abi, signerOrProvider) as NativeSSOV;
  }
}
