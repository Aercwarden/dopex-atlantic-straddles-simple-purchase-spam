...
import type { RateVault, RateVaultInterface } from "../RateVault";
...
export class RateVault__factory {
  static readonly abi = _abi;
  static createInterface(): RateVaultInterface {
    return new utils.Interface(_abi) as RateVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RateVault {
    return new Contract(address, _abi, signerOrProvider) as RateVault;
  }
}
