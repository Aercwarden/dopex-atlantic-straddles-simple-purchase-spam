...
export interface EscrowInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "updateTradeFeePercentage"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "addBaseTokens",
  ...
  encodeFunctionData(
    functionFragment: "baseAddresses",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "quoteAddresses",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tradeFeePercentage",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateTradeFeePercentage",
...
export type AddTokenEvent = TypedEvent<[string, boolean], AddTokenEventObject>;
...
export type FulfillEventFilter = TypedEventFilter<FulfillEvent>;
...
export interface Escrow extends BaseContract {
  ...
  functions: {
    ...
    open(
      ...
      receiveAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "Cancel(address,address,address,address,uint256)"(
      dealer?: PromiseOrValue<string> | null,
    ...
    "Fulfill(address,address,address,address,uint256,uint256)"(
      counterParty?: PromiseOrValue<string> | null,
      dealer?: PromiseOrValue<string> | null,
      quote?: null,
      base?: null,
      dealerSendAmount?: null,
      dealerReceiveAmount?: null
    ): FulfillEventFilter;
    Fulfill(
      counterParty?: PromiseOrValue<string> | null,
      dealer?: PromiseOrValue<string> | null,
    ...
    "Open(address,address,address,address,uint256,uint256)"(
      dealer?: PromiseOrValue<string> | null,
      counterParty?: PromiseOrValue<string> | null,
      quote?: null,
      base?: null,
