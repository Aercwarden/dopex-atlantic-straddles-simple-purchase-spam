...
export interface ERC20SSOVInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTotalEpochCallsPurchased",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalEpochBalance",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export type NewStrikeEvent = TypedEvent<
  [BigNumber, BigNumber],
...
export interface ERC20SSOV extends BaseContract {
  ...
  filters: {
    ...
    "NewStrike(uint256,uint256)"(
      epoch?: null,
      strike?: null
    ): NewStrikeEventFilter;
