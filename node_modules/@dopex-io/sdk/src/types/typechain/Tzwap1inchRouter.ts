...
export declare namespace TZWAP {
  ...
  export type OracleStructOutput = [string, boolean] & {
  ...
  export type UnoswapParamsStruct = {
  ...
  export type UnoswapParamsStructOutput = [
    string,
    BigNumber,
    BigNumber,
    string[]
  ...
  export type UniswapV3ParamsStruct = {
    amount: PromiseOrValue<BigNumberish>;
    minReturn: PromiseOrValue<BigNumberish>;
    pools: PromiseOrValue<BigNumberish>[];
  };

  export type UniswapV3ParamsStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber[]
  ] & { amount: BigNumber; minReturn: BigNumber; pools: BigNumber[] };
...
export interface Tzwap1inchRouterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, TZWAP.OracleStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getDstTokensReceivedForOrder",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getSrcTokensSwappedForOrder",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getSrcTokensToSwap",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getTicksFilled",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getTicksToFill",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getTimeElapsedSinceLastFill",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "isOrderActive",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "minNumOfIntervals",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "newOrder",
    values: [TZWAP.TWAPOrderStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "percentagePrecision",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type LogNewFillEvent = TypedEvent<
  [BigNumber, BigNumber],
  LogNewFillEventObject
>;

export type LogNewFillEventFilter = TypedEventFilter<LogNewFillEvent>;

export interface LogNewOrderEventObject {
  id: BigNumber;
}
export type LogNewOrderEvent = TypedEvent<[BigNumber], LogNewOrderEventObject>;

export type LogNewOrderEventFilter = TypedEventFilter<LogNewOrderEvent>;

export interface LogOrderKilledEventObject {
  id: BigNumber;
}
export type LogOrderKilledEvent = TypedEvent<
  [BigNumber],
  LogOrderKilledEventObject
>;

export type LogOrderKilledEventFilter = TypedEventFilter<LogOrderKilledEvent>;
...
export interface Tzwap1inchRouter extends BaseContract {
  ...
  functions: {
    ...
    fillOrder(
      ...
      _swapParams: TZWAP.SwapParamsStruct,
      _unoswapParams: TZWAP.UnoswapParamsStruct,
      _uniswapV3Params: TZWAP.UniswapV3ParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    oracles(
      ...
      [string, boolean] & { oracleAddress: string; isChainlink: boolean }
    >;
  ...
  filters: {
    "LogNewFill(uint256,uint256)"(
      id?: null,
      fillIndex?: null
    ): LogNewFillEventFilter;
