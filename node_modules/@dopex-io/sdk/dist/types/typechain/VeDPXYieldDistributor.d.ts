...
export interface VeDPXYieldDistributorInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "checkpoint" | "checkpointOtherUser" | "earned" | "eligibleCurrentVeDPX" | "emittedToken" | "emitted_token_address" | "fractionParticipating" | "getYield" | "getYieldForDuration" | "greylist" | "greylistAddress" | "lastTimeYieldApplicable" | "lastUpdateTime" | "notifyRewardAmount" | "owner" | "periodFinish" | "recoverERC20" | "renounceOwnership" | "reward_notifiers" | "setPauses" | "setYieldDuration" | "setYieldRate" | "sync" | "toggleRewardNotifier" | "totalVeDPXParticipating" | "totalVeDPXSupplyStored" | "transferOwnership" | "userIsInitialized" | "userVeDPXCheckpointed" | "userVeDPXEndpointCheckpointed" | "userYieldPerTokenPaid" | "yieldCollectionPaused" | "yieldDuration" | "yieldPerVeDPX" | "yieldPerVeDPXStored" | "yieldRate" | "yields"): FunctionFragment;
...
export declare type DefaultInitializationEvent = TypedEvent<[
], DefaultInitializationEventObject>;
export declare type DefaultInitializationEventFilter = TypedEventFilter<DefaultInitializationEvent>;
export interface OldYieldCollectedEventObject {
    user: string;
    yield: BigNumber;
    token_address: string;
}
export declare type OldYieldCollectedEvent = TypedEvent<[
    string,
    BigNumber,
    string
], OldYieldCollectedEventObject>;
export declare type OldYieldCollectedEventFilter = TypedEventFilter<OldYieldCollectedEvent>;
...
export declare type RecoveredERC20Event = TypedEvent<[
    string,
    BigNumber
], RecoveredERC20EventObject>;
export declare type RecoveredERC20EventFilter = TypedEventFilter<RecoveredERC20Event>;
...
export declare type YieldCollectedEvent = TypedEvent<[
    string,
    BigNumber,
    string
], YieldCollectedEventObject>;
export declare type YieldCollectedEventFilter = TypedEventFilter<YieldCollectedEvent>;
export interface YieldDurationUpdatedEventObject {
    newDuration: BigNumber;
}
export declare type YieldDurationUpdatedEvent = TypedEvent<[
    BigNumber
], YieldDurationUpdatedEventObject>;
export declare type YieldDurationUpdatedEventFilter = TypedEventFilter<YieldDurationUpdatedEvent>;
export interface YieldPeriodRenewedEventObject {
    token: string;
    yieldRate: BigNumber;
}
export declare type YieldPeriodRenewedEvent = TypedEvent<[
    string,
    BigNumber
], YieldPeriodRenewedEventObject>;
export declare type YieldPeriodRenewedEventFilter = TypedEventFilter<YieldPeriodRenewedEvent>;
export interface VeDPXYieldDistributor extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: VeDPXYieldDistributorInterface;
    ...
    functions: {
        ...
        eligibleCurrentVeDPX(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
    ...
    populateTransaction: {
        ...
        userVeDPXEndpointCheckpointed(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
