...
export interface RateVaultInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addToContractWhitelist" | "addresses" | "bootstrap" | "calculatePnl" | "calculatePremium" | "calculatePurchaseFees" | "calculateSettlementFees" | "crvLP" | "crvPool" | "currentEpoch" | "depositMultiple" | "emergencyWithdraw" | "expireDelayTolerance" | "expireEpoch()" | "expireEpoch(uint256)" | "getAddress" | "getCurrentRate" | "getEpochData" | "getEpochLeverages" | "getEpochPremiums" | "getEpochStrikeData" | "getEpochStrikes" | "getEpochTimes" | "getEpochTokens" | "getLpPrice" | "getVolatility" | "isContract" | "optionsTokenImplementation" | "owner" | "pause" | "paused" | "purchase" | "removeFromContractWhitelist" | "renounceOwnership" | "setAddresses" | "setLeverages" | "setStrikes" | "settle" | "totalEpochData" | "totalStrikeData" | "transferOwnership" | "unpause" | "updateExpireDelayTolerance" | "userEpochStrikeDeposits" | "userStrikePurchaseData" | "whitelistedContracts" | "withdrawMultiple"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getCurrentRate", values?: undefined): string;
    encodeFunctionData(functionFragment: "getEpochData", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getEpochLeverages", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getEpochPremiums", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getEpochStrikeData", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "getEpochTokens", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "setLeverages", values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<BigNumberish>[]]): string;
    ...
    encodeFunctionData(functionFragment: "totalEpochData", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "totalStrikeData", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "userEpochStrikeDeposits", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "userStrikePurchaseData", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "whitelistedContracts", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "withdrawMultiple", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>[],
        PromiseOrValue<BigNumberish>[],
        PromiseOrValue<BigNumberish>[],
    ...
    decodeFunctionResult(functionFragment: "getCurrentRate", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getEpochData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getEpochLeverages", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getEpochPremiums", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getEpochTokens", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setLeverages", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setStrikes", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "settle", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "totalEpochData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "totalStrikeData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "transferOwnership", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "unpause", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "updateExpireDelayTolerance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "userEpochStrikeDeposits", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "userStrikePurchaseData", data: BytesLike): Result;
...
export declare type CallsLeverageSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], CallsLeverageSetEventObject>;
export declare type CallsLeverageSetEventFilter = TypedEventFilter<CallsLeverageSetEvent>;
...
export declare type PutsLeverageSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], PutsLeverageSetEventObject>;
export declare type PutsLeverageSetEventFilter = TypedEventFilter<PutsLeverageSetEvent>;
...
export interface RateVault extends BaseContract {
    ...
    functions: {
        ...
        bootstrap(_expiry: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        calculatePnl(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber]>;
        calculatePremium(_strike: PromiseOrValue<BigNumberish>, _amount: PromiseOrValue<BigNumberish>, _isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber] & {
            premium: BigNumber;
        }>;
        calculatePurchaseFees(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber]>;
        calculateSettlementFees(rateAtSettlement: PromiseOrValue<BigNumberish>, pnl: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber]>;
        crvLP(overrides?: CallOverrides): Promise<[string]>;
        crvPool(overrides?: CallOverrides): Promise<[string]>;
        currentEpoch(overrides?: CallOverrides): Promise<[BigNumber]>;
        depositMultiple(strikeIndex: PromiseOrValue<BigNumberish>[], callLeverageIndex: PromiseOrValue<BigNumberish>[], putLeverageIndex: PromiseOrValue<BigNumberish>[], amount: PromiseOrValue<BigNumberish>[], user: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "expireEpoch(uint256)"(rateAtSettlement: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        getEpochData(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], string[], string[]]>;
        getEpochLeverages(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]]>;
        getEpochPremiums(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]]>;
        getEpochStrikeData(epoch: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]]>;
        ...
        getEpochTokens(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string[], string[]]>;
        ...
        purchase(strikeIndex: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, amount: PromiseOrValue<BigNumberish>, user: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setLeverages(callsLeverages: PromiseOrValue<BigNumberish>[], putsLeverages: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setStrikes(strikes: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        settle(strikeIndex: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, amount: PromiseOrValue<BigNumberish>, epoch: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        totalEpochData(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        totalStrikeData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        userEpochStrikeDeposits(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
        ...
        userStrikePurchaseData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber
        ...
        withdrawMultiple(epoch: PromiseOrValue<BigNumberish>, strikeIndex: PromiseOrValue<BigNumberish>[], callLeverageIndex: PromiseOrValue<BigNumberish>[], putLeverageIndex: PromiseOrValue<BigNumberish>[], user: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    addToContractWhitelist(_contract: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        addresses(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        bootstrap(_expiry: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
        calculatePnl(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        calculatePremium(_strike: PromiseOrValue<BigNumberish>, _amount: PromiseOrValue<BigNumberish>, _isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        calculatePurchaseFees(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        calculateSettlementFees(rateAtSettlement: PromiseOrValue<BigNumberish>, pnl: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        crvPool(overrides?: CallOverrides): Promise<string>;
        currentEpoch(overrides?: CallOverrides): Promise<BigNumber>;
        depositMultiple(strikeIndex: PromiseOrValue<BigNumberish>[], callLeverageIndex: PromiseOrValue<BigNumberish>[], putLeverageIndex: PromiseOrValue<BigNumberish>[], amount: PromiseOrValue<BigNumberish>[], user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        ...
        "expireEpoch(uint256)"(rateAtSettlement: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
        getAddress(name: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        getCurrentRate(overrides?: CallOverrides): Promise<BigNumber>;
        getEpochData(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], string[], string[]]>;
        getEpochLeverages(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]]>;
        ...
        paused(overrides?: CallOverrides): Promise<boolean>;
        purchase(strikeIndex: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, amount: PromiseOrValue<BigNumberish>, user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        setLeverages(callsLeverages: PromiseOrValue<BigNumberish>[], putsLeverages: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<boolean>;
        setStrikes(strikes: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<boolean>;
        settle(strikeIndex: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, amount: PromiseOrValue<BigNumberish>, epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        totalEpochData(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        whitelistedContracts(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        withdrawMultiple(epoch: PromiseOrValue<BigNumberish>, strikeIndex: PromiseOrValue<BigNumberish>[], callLeverageIndex: PromiseOrValue<BigNumberish>[], putLeverageIndex: PromiseOrValue<BigNumberish>[], user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        ...
        "CallsLeverageSet(uint256,uint256)"(epoch?: null, Leverage?: null): CallsLeverageSetEventFilter;
        CallsLeverageSet(epoch?: null, Leverage?: null): CallsLeverageSetEventFilter;
        ...
        "EpochExpired(address,uint256)"(sender?: null, rateAtSettlement?: null): EpochExpiredEventFilter;
        EpochExpired(sender?: null, rateAtSettlement?: null): EpochExpiredEventFilter;
        ...
        "PutsLeverageSet(uint256,uint256)"(epoch?: null, Leverage?: null): PutsLeverageSetEventFilter;
        ...
        "Withdraw(uint256,uint256,address,uint256,uint256,uint256)"(epoch?: null, strike?: null, user?: null, userDeposits?: null, crvLPWithdrawn?: null, crvRewards?: null): WithdrawEventFilter;
        Withdraw(epoch?: null, strike?: null, user?: null, userDeposits?: null, crvLPWithdrawn?: null, crvRewards?: null): WithdrawEventFilter;
    };
    estimateGas: {
        addToContractWhitelist(_contract: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        getEpochLeverages(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getEpochPremiums(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getEpochStrikeData(epoch: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getEpochStrikes(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getEpochTimes(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getEpochTokens(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getLpPrice(overrides?: CallOverrides): Promise<BigNumber>;
        getVolatility(_strike: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        totalEpochData(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        totalStrikeData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        transferOwnership(newOwner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        unpause(overrides?: Overrides & {
        ...
        userEpochStrikeDeposits(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        userStrikePurchaseData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        calculatePnl(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculatePremium(_strike: PromiseOrValue<BigNumberish>, _amount: PromiseOrValue<BigNumberish>, _isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculatePurchaseFees(price: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateSettlementFees(rateAtSettlement: PromiseOrValue<BigNumberish>, pnl: PromiseOrValue<BigNumberish>, amount: PromiseOrValue<BigNumberish>, isPut: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getEpochLeverages(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getEpochPremiums(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getEpochStrikeData(epoch: PromiseOrValue<BigNumberish>, strike: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getEpochTokens(epoch: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        totalEpochData(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        totalStrikeData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        transferOwnership(newOwner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        unpause(overrides?: Overrides & {
        ...
        userEpochStrikeDeposits(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        userStrikePurchaseData(arg0: PromiseOrValue<BigNumberish>, arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
