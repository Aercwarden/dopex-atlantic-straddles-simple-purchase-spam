...
export interface DPXVotingEscrowInterface extends utils.Interface {
    functions: {
...
export declare type SupplyEvent = TypedEvent<[BigNumber, BigNumber], SupplyEventObject>;
...
export interface DPXVotingEscrow extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DPXVotingEscrowInterface;
