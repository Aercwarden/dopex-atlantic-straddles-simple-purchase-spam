...
export interface StakingRewardsV3Interface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addToContractWhitelist" | "balanceOf" | "boost" | "boostedFinish" | "boostedTimePeriod" | "claim" | "earned" | "emergencyWithdraw" | "endRewards" | "exit" | "isContract" | "lastTimeRewardApplicable" | "lastUpdateTime" | "notifyRewardAmount" | "owner" | "paused" | "periodFinish" | "removeFromContractWhitelist" | "renounceOwnership" | "rewardDuration" | "rewardEarned" | "rewardPerToken" | "rewardPerTokenStored" | "rewardRate" | "rewardToken" | "stake" | "stakingToken" | "totalSupply" | "transferOwnership" | "unstake" | "updateBoost" | "updateBoostedTimePeriod" | "updateRewardDuration" | "userRewardPerTokenPaid" | "whitelistedContracts"): FunctionFragment;
...
export declare type BoostUpdatedEvent = TypedEvent<[
    BigNumber
], BoostUpdatedEventObject>;
export declare type BoostUpdatedEventFilter = TypedEventFilter<BoostUpdatedEvent>;
export interface BoostedTimePeriodUpdatedEventObject {
    boostedTimePeriod: BigNumber;
}
export declare type BoostedTimePeriodUpdatedEvent = TypedEvent<[
    BigNumber
], BoostedTimePeriodUpdatedEventObject>;
export declare type BoostedTimePeriodUpdatedEventFilter = TypedEventFilter<BoostedTimePeriodUpdatedEvent>;
...
export declare type RewardAddedEvent = TypedEvent<[BigNumber], RewardAddedEventObject>;
...
export declare type RewardDurationUpdatedEvent = TypedEvent<[
    BigNumber
], RewardDurationUpdatedEventObject>;
export declare type RewardDurationUpdatedEventFilter = TypedEventFilter<RewardDurationUpdatedEvent>;
...
export interface StakingRewardsV3 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StakingRewardsV3Interface;
    ...
    functions: {
        ...
        endRewards(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        notifyRewardAmount(rewardAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        updateBoost(_boost: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateBoostedTimePeriod(_boostedTimePeriod: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateRewardDuration(_rewardDuration: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
